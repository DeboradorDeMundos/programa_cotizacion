...
$sql = "SELECT c.id_cotizacion AS cotizacion_id, c.fecha_emision, c.fecha_validez, c.total_final, 
...
if ($result->num_rows > 0) { // Si hay filas en el resultado
    ...
    while ($row = $result->fetch_assoc()) { // Obtiene una fila asociativa del resultado
        ...
        $mensaje .= "<td>" . htmlspecialchars($row['total_final']) . "</td>"; // Total general de la cotización
        ...
        $mensaje .= "<td>
                        ...
                        <a href='../programa_cotizacion/eliminar_cotizacion.php?id=" . $row['cotizacion_id'] . "'>Eliminar</a> |
                     </td>";
...
<head>
    ...
    <link rel="stylesheet" href="../../css/programa_cotizacion/ver_listado.css"> <!-- Incluye la hoja de estilos CSS externa -->
</head>
<body>
    ...
    <ul>
        ...
        <li><a href="../../programa_cotizacion.php">Volver al Menú</a></li> <!-- Enlace para volver al menú principal -->
    </ul>
</body>
</html>
