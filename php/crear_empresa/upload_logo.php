...
<div class="box-6 logo-box"> <!-- Crea una caja para el logo o foto de perfil, ocupando 6 de las 12 columnas disponibles en el diseño -->
    ...
    <label for="cargar-logo" class="logo-contenedor"> <!-- Etiqueta para el campo de carga de imagen. El atributo "for" enlaza con el input de archivo -->
        <img src="http://localhost/programa_cotizacion/imagenes/crear_empresa/generic-logo.png" alt="tamaño recomendado: 800x200 pixeles" class="logo" id="logo-previsualizar"> <!-- Muestra una imagen previa del logo con un texto alternativo en caso de que no se cargue la imagen -->
        <input type="file" id="cargar-logo" name="logo_upload" accept="image/*" required style="display:none;"> <!-- Campo oculto para cargar el archivo del logo. Acepta solo archivos de imagen -->
        <button for="cargar-logo" class="logo" type="file" id ="cargar-logo" name="logo_upload" accept="image/*" style="display:block;">Sube tu Logo Empresarial tamaño recomendado: 800x200 pixeles formato: png</button > <!-- Texto que aparece junto a la imagen para instruir al usuario a cargar el logo -->  
    </label>
    <div id="logo-mensaje" class="message" style="color: red; display: none;">Ingresa tu logo para continuar</div> 
</div>
