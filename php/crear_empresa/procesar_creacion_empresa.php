...
// Incrementa para mantener el correlativo dentro de la empresa
if ($last_num_cotizacion) {
    $numero_cotizacion = (int)$last_num_cotizacion + 1;
} else {
...
// Asocia los parámetros a la declaración preparada
