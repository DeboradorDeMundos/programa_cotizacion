    ...
    <div class="box-6 cuadro-datos"> <!-- Crea una caja para ingresar datos, ocupando 6 de las 12 columnas disponibles en el diseño -->
        <div class="form-group-inline">
            ...
            <div class="form-group">
                ...
                <input type="text" id="vendedor_nombre" name="vendedor_nombre" 
                    ...
                    required> <!-- Campo de texto para ingresar el nombre del vendedor. El atributo "required" hace que el campo sea obligatorio -->
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="email" id="vendedor_email" name="vendedor_email" 
                ...
                required> <!-- Campo de correo electrónico para ingresar el email del vendedor. El tipo "email" valida que el texto ingresado sea una dirección de correo electrónico. También es obligatorio -->
        </div>
    </div>
    <div class="box-6 cuadro-datos cuadro-datos-left"> <!-- Crea otra caja para ingresar datos, ocupando las otras 6 columnas. Se aplica una clase adicional "cuadro-datos-left" para estilo -->
        <div class="form-group">
            ...
            <input type="text" id="vendedor_telefono" name="vendedor_telefono" 
                value="<?php echo htmlspecialchars($vendedor_telefono); ?>"> <!-- Campo de texto para ingresar el teléfono del vendedor. Este campo no es obligatorio -->
        </div>
        <div class="form-group">
            ...
            <input type="text" id="vendedor_celular" name="vendedor_celular" 
                value="<?php echo htmlspecialchars($vendedor_celular); ?>"> <!-- Campo de texto para ingresar el número de celular del vendedor. Este campo no es obligatorio -->
        </div>
    </div>
</fieldset>
