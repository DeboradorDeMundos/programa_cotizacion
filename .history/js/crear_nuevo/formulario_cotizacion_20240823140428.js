...
function addDetailRow(button) {
    ...
    tableBody.appendChild(newRow);
        ...
        // Recalcular totales después de agregar una nueva fila
        calculateTotals();
}
...
function calculateTotals() {
    ...
    // Aquí puedes calcular el IVA, descuento y total con descuento
    ivaTotal = (subtotal * 0.19).toFixed(2); // 19% IVA
    descuentoTotal = document.querySelector('input[name="detalle_descuento[]"]').value || 0;
    totalConDescuento = (subtotal + parseFloat(ivaTotal) - parseFloat(descuentoTotal)).toFixed(2);
    ...
    document.querySelector('input[name="detalle_total[]"]').value = subtotal.toFixed(2);
    document.querySelector('input[name="detalle_descuento[]"]').value = descuentoTotal;
