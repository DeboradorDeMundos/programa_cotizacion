...
/* --------------------------------------------------------------------------------------------------------------
    ...
    function addDetailSection() {
        ...
        addTitleButton.onclick = function() { addTitle(flexibleContainer, newSection); };
        ...
        addHeaderButton.onclick = function() { addHeader(flexibleContainer); };
    ...
    function addTitle(container, section) {
    ...
    function addHeader(container) {
        ...
        removeHeaderButton.onclick = function() { tableContainer.remove(); };
