...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="php/programa_cotizacion/formulario_cotizacion/formulario_cotizacion.php">Ver listado Cotización</a></li><!-- Enlace para ver el listado de cotizaciones -->
        </ul>
    </nav>
</body>
</html>
