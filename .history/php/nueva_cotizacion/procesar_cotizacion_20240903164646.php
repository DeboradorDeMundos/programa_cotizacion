...
$sql = "INSERT INTO C_/Encargados (nombre_encargado, email_encargado, fono_encargado, celular_encargado)
        VALUES (?, ?, ?, ?)
...
// Obtener id_proyecto
$sql = "SELECT id_proyecto FROM eproyectos WHERE codigo_proyecto = ?";
$stmt = $conn->prepare($sql);
