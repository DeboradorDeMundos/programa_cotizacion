...
<head> <!-- Abre el elemento de cabecera que contiene metadatos y enlaces a recursos externos -->
    ...
    <link rel="stylesheet" href="../..//nueva_cotizacion/cargar_logo_empresa.css"> <!-- Enlaza una hoja de estilo externa que se encuentra en la ruta especificada para estilizar el contenido de la página -->
