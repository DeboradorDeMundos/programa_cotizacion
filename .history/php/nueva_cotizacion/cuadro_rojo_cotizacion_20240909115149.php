...
<fieldset class="box-6 data-box data-box-red"> <!-- Crea una caja para ingresar datos, ocupando otras 6 columnas. Se aplica una clase adicional para estilo -->
    ...
    <input type="number" id="dias_validez" name="dias_validez" required min="1" placeholder="30" onchange="calcularFechaValidez()" value="<?php echo htmlspecialchars($dias_validez); ?>" readonly>
