...
for ($index = 0; $index < $numero_detalles; $index++) {
    ...
    if ($titulo) {
        ...
        if ($descripcion) {
            $sql_insert_descripcion = "INSERT INTO C_Descripciones (id_titulo, descripcion, precio_unitario) VALUES (?, ?, ?)";
            ...
            $sql_insert_detalle = "INSERT INTO C_Detalle_Cotizacion (id_cotizacion, id_descripcion, cantidad) VALUES (?, ?, ?)";
