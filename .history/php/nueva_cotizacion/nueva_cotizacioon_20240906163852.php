...
<head>
    ...
    <link rel="stylesheet" href="../../css/nueva_cotizacion/nueva_cotizacion.css"> <!-- Archivo CSS principal -->
    <link rel="stylesheet" href="../../css/crear_empresa/cargar_logo_empresa.css"> <!-- Archivo CSS del logo -->
</head>
<body>
    ...
    <script src="../../js/crear_empresa/cargar_logo_empresa.js"></script> <!-- Archivo JS del logo -->
</body>
</html>
