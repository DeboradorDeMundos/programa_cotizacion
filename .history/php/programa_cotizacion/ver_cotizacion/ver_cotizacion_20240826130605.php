...
if ($id > 0) {  // Verifica si el 'id' es mayor que 0
    ...
    if ($result->num_rows > 0) {  // Verifica si hay resultados en la consulta
        ...
        // Fila de TOTAL CON DESCUENTO
        echo "<tr><td colspan='3' align='right'><strong>TOTAL CON DESCUENTO</strong></td><td align='right'>" . htmlspecialchars($row['total_con_descuento']) . "</td></tr>"; // Fila de TOTAL CON DESCUENTO
...
<head>
    ...
    <link rel="stylesheet" href="css/index.css"> <!-- Vincula el archivo de estilos CSS -->
</head>
<body>
    <ul> <!-- Crea una lista desordenada -->
        ...
        <li><a href="../modificar/modificar.php?id=<?php echo $id; ?>">Modificar Cotización</a></li> <!-- Enlace para modificar la cotización actual, con ID incluido -->
        <li><a href="../eliminar/eliminar.php?id=<?php echo $id; ?>">Eliminar Cotización</a></li> <!-- Enlace para eliminar la cotización actual, con ID incluido -->
