...
<?php
    ...
    $sql_cotizacion = "INSERT INTO c_cotizaciones (
        numero_cotizacion, fecha_emision, dias_validez , fecha_validez, id_cliente, id_proyecto, id_empresa, id_vendedor, 
        id_encargado
    ...
    $stmt_cotizacion->bind_param("sii", 
        $numero_cotizacion,$id_empresa,$id_empresa
    );
