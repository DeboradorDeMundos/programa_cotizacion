...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['empresa_nombre'])) {
        ...
        $sql_empresa = "INSERT INTO E_Empresa (id_fotorut_empresa, nombre_empresa, area_empresa, direccion_empresa, telefono_empresa, email_empresa, fecha_creacion, dias_validez)
                        VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
