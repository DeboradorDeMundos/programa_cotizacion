...
if ($result->num_rows > 0) {
    ...
    $mensaje .= "<tr><th>Proyecto</th><th>Código Prov</th><th>Empresa</th><th>RUT</th><th>Dirección</th><th>Teléfono</th><th>Email</th><th>Cantidad</th><th>Descripción</th><th>Precio Unitario</th></tr>";
...
<body>
    <?php echo $mensaje; ?>
    <ul>
        <li><a href="php/crear_nuevo/crear.php">Volver a Crear Cotización</a></li>
        <li><a href="cotizacion_ired_spa/index.php">Volver al Menú</a></li>
    </ul>
</body>
</html>
