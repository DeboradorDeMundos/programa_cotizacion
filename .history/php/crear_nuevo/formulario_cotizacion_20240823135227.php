    ...
    <div id="detalle-container">
        ...
        <div class="detalle-section">
            ...
            <table class="detalle-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="number" name="detalle_total_item[]" step="0.01" min="0" value="0" readonly></td>
            ...
            <table class="calculo-table">
                ...
                <tbody>
                    <tr>
                        <td><input type="number" name="detalle_neto[]" step="0.01" min="0" required></td>
                        <td><input type="number" name="detalle_iva[]" step="0.01" min="0" required></td>
                        <td><input type="number" name="detalle_total[]" step="0.01" min="0" required></td>
