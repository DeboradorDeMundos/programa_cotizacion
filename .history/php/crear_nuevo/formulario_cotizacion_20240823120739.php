            ...
            <fieldset>
                ...
                <table id="detalle_cotizacion">
                    ...
                    <tbody>
                        <!-- Fila de ejemplo -->
                        <tr>
                            <td><input type="text" name="detalle_titulo[]" required></td>
                            <td>
                                <textarea name="detalle_descripcion[]" rows="4" placeholder="Descripción detallada" required></textarea>
                                <div class="descripcion-adicionales">
                                    <!-- Sección para descripciones adicionales -->
                                    <input type="text" name="detalle_descripcion_adicionales[]" placeholder="Descripción adicional 1">
                                    <input type="number" name="detalle_precio_unitario_adicional[]" step="0.01" min="0" placeholder="Precio unitario">
                                    <button type="button" onclick="addDescripcionAdicional(this)">Agregar Descripción Adicional</button>
                                </div>
                            </td>
                ...
                <button type="button" onclick="addDetailRow()">Agregar Título</button>
            </fieldset>
