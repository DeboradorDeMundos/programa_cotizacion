...
$empresa_nombre = isset($_POST['empresa_nombre']) ? $_POST['empresa_nombre'] : null;
...
if (!$cliente_id) {
    $sql_cliente = "INSERT INTO Clientes (nombre_cliente, rut) VALUES (?, ?)";
    $stmt_cliente = $conn->prepare($sql_cliente);
    $stmt_cliente->bind_param("ss", $cliente_nombre, $cliente_rut);
