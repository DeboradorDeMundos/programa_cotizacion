...
$stmt = $conn->prepare($sql);
$stmt->bind_param("sssssiiissiii", $numero_cotizacion, $fecha_emision, $validez_cotizacion, $dias_compra, $dias_trabajo, $trabajadores, $horario, $colacion, $entrega, $id_cliente, $id_proyecto, $id_empresa, $id_vendedor, $id_encargado);
$stmt->execute();
