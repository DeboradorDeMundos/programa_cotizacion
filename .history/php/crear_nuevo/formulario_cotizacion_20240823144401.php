            ...
            <table class="detalle-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="number" name="detalle_iva[]" required></td>
                        <td><input type="number" name="detalle_total[]" step="0" min="0" required></td>
                        <td><input type="number" name="detalle_descuento[]" step="0" min="0" value="0"></td>
                        <td><input type="number" name="detalle_total_con_descuento[]" step="0" min="0" value="0"></td>
                    </tr>
                </tbody>
            </table>
        </fieldset>
