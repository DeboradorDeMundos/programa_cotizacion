...
if (!$encargado_id) {
    $sql_encargado = "INSERT INTO Encargados (nombre_encargado, email_encargado, telefono_encargado, celular_encargado, proyecto_encargado) 
                      VALUES (?, ?, ?, ?, ?)";
...
if (!$vendedor_id) {
    $sql_vendedor = "INSERT INTO Vendedores (nombre_vendedor, email_vendedor, telefono_vendedor, celular_vendedor) 
                      VALUES (?, ?, ?, ?)";
