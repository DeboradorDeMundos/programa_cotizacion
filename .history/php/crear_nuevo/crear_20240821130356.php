...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO nombre_proyecto (nombre, codigo_prov, cliente_empresa, cliente_rut, cliente_direccion, cliente_fono, cliente_email, cantidad, descripcion, precio_unitario) 
