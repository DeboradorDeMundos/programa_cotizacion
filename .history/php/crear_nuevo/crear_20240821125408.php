...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO nombre_proyecto (nombre_proyecto, codigo_prov, cliente_empresa, cliente_rut, cliente_direccion, cliente_fono, cliente_email, cantidad, descripcion, precio_unitario) 
            VALUES ('$proyecto', '$cod_prov', '$cliente_empresa', '$cliente_rut', '$cliente_direccion', '$cliente_fono', '$cliente_email', '$cantidad', '$descripcion', '$precio_unitario')";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        $mensaje .= "<a href='ver_nuevo.php'>Ver Todas las Cotizaciones</a>"; // Enlace para ver cotizaciones
    } else {
