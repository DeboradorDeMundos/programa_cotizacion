...
<div id="calculos-finales">
        <fieldset>
            ...
            <table class="detalle-table">
                ...
                <tbody>
                    <tr>
                    <input type="number" name="detalle_neto" step="1" min="1" required>
                    <input type="number" name="detalle_iva" required>
                    <input type="number" name="detalle_total" step="0" min="0" required>
                    <input type="number" name="detalle_descuento" step="0" min="0" value="0">
                    <input type="number" name="detalle_total_con_descuento" step="0" min="0" value="0">
                    </tr>
                </tbody>
            </table>
        </fieldset>
