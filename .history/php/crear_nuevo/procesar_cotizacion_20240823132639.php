    ...
    // Manejar detalle de cotización
    $titulos = $_POST['detalle_titulo'];
    $cantidades = $_POST['detalle_cantidad'];
    $descripciones = $_POST['detalle_descripcion'];
    $precios_unitarios = $_POST['detalle_precio_unitario'];
    $descuentos = $_POST['detalle_descuento'];
