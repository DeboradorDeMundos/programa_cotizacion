    ...
    Memoria actualizada
    El error que estás experimentando ocurre porque tu script PHP todavía intenta insertar datos en la columna proyecto_encargado en la tabla Encargados, que ya no existe. Debes actualizar tu código PHP para eliminar las referencias a proyecto_encargado.
    
    Aquí tienes el fragmento de código corregido:
