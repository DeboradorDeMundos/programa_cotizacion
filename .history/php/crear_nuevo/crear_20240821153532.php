...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Inserta los detalles del servicio
        ...
        // Inserta la información adicional
        ...
        $mensaje .= "<p><strong>Proyecto:</strong> " . htmlspecialchars($proyecto_nombre) . "</p>";
        $mensaje .= "<p><strong>Cliente:</strong> " . htmlspecialchars($cliente_nombre) . "</p>";
        $mensaje .= "<p><strong>Vendedor:</strong> " . htmlspecialchars($vendedor_nombre) . "</p>";
        $mensaje .= "<p><strong>Total Cotización:</strong> " . htmlspecialchars($total_servicio) . "</p>";
        $mensaje .= "<a href='ver_nuevo.php'>Ver Todas las Cotizaciones</a>";
    } catch (Exception $e) {
        $conn->rollback();
