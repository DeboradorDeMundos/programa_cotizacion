...
// Sección: Detalle Cotización
$contenido_pdf .= "q\n1 0 0 RG\n"; // Color rojo
$contenido_pdf .= "2 w\n"; // Espesor del borde
$contenido_pdf .= "50 " . (700 - $margen_superior) . " 500 80 re S\n"; // Rectángulo para Detalle Cotización
$contenido_pdf .= "Q\n";

// Título de Detalle Cotización
$contenido_pdf .= "BT\n/F1 14 Tf\n60 " . (675 - $margen_superior) . " Td\n(Detalle Cotización) Tj\n";
$contenido_pdf .= "ET\n";

// Datos de la cotización
$contenido_pdf .= "BT\n/F1 12 Tf\n60 " . (655 - $margen_superior) . " Td\n(RUT de la Empresa: " . utf8_decode($row['rut_empresa']) . ") Tj\n";
$contenido_pdf .= "0 -15 Td\n(Numero de Cotización: " . $id_cotizacion . ") Tj\n";
$contenido_pdf .= "0 -15 Td\n(Días Validez: 30) Tj\n"; // Cambia según necesites
$contenido_pdf .= "0 -15 Td\n(Fecha de Validez: " . utf8_decode($row['fecha_validez']) . ") Tj\n";
$contenido_pdf .= "ET\n";

// Fecha de emisión
$contenido_pdf .= "BT\n/F1 12 Tf\n60 " . (605 - $margen_superior) . " Td\n(Fecha de Emisión: " . utf8_decode($row['fecha_emision']) . ") Tj\n";
$contenido_pdf .= "ET\n";

// Separador
$contenido_pdf .= "q\n0 0 0 RG\n"; // Color negro
$contenido_pdf .= "1 w\n"; // Espesor del borde
$contenido_pdf .= "50 " . (590 - $margen_superior) . " 500 1 re S\n"; // Línea de separación
$contenido_pdf .= "Q\n";

// Sección: Detalle Empresa
$contenido_pdf .= "BT\n/F1 14 Tf\n50 " . (570 - $margen_superior) . " Td\n(Detalle Empresa) Tj\n";
$contenido_pdf .= "ET\n";
