...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        // Agregar el contenido de la cotización (hex para caracteres especiales)
        $contenido .= "BT\n/F1 24 Tf\n100 750 Td\n(Cotizaci\xf3n N\xb0 " . $id_cotizacion . ") Tj\n";
        $contenido .= "/F1 12 Tf\n100 730 Td\n(Fecha de Emisi\xf3n: " . $row['fecha_emision'] . ") Tj\n";
        ...
        $contenido .= "100 630 Td\n(Direcci\xf3n: " . $row['direccion_cliente'] . ") Tj\n";
        $contenido .= "100 610 Td\n(Tel\xe9fono: " . $row['telefono_cliente'] . ") Tj\n";
