...
$sql = "SELECT c.id_cotizacion AS cotizacion_id, c.fecha_emision, c.fecha_validez,c.numero_cotizacion ,t.total_final, 
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        $mensaje .= "<tr>";
        $mensaje .= "<td>" . htmlspecialchars($row['numero']) . "</td>";
