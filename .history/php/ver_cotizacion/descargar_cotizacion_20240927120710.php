...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $contenido_pdf .= "0 -15 Td\n(Nombre: " . $row['nombre_empresa'] . ") Tj\n";
        $contenido_pdf .= "0 -15 Td\n(Área: " . $row['nombre_empresa'] . ") Tj\n"; // Puedes cambiar el área según necesitesarea_empresa
