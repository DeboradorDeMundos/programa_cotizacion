...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (file_exists($ruta_logo)) {
            ...
            $contenido_pdf .= "5 0 obj\n<< /Type /XObject /Subtype /Image /Width 100 /Height 100 /Filter /DCTDecode /Length " . $img_length . " >>\nstream\n";
            $contenido_pdf .= $img_data . "\nendstream\nendobj\n"; // Insertar la imagen
        } else {
            // Manejar el caso en que no se encuentra la imagen
            $contenido_pdf .= "5 0 obj\n<< /Type /XObject /Subtype /Image /Width 100 /Height 100 /Filter /DCTDecode /Length 0 >>\nstream\nendstream\nendobj\n"; // Imagen vacía
        }
