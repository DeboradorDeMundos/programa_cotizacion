...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (file_exists($ruta_logo_absoluta)) {
            $contenido_pdf .= "q\n";
            $contenido_pdf .= "$scaled_width 0 0 $scaled_height 50 " . (720 - $margen_superior) . " cm\n";  // Posición y tamaño del logo
        ...
        echo "No se encontraron detalles para la cotización.";
    }
    $stmt->close();
} else {
