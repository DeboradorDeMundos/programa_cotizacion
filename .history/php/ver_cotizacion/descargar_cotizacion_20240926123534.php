...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        // Añadir la imagen de la empresa (suponiendo que la ruta es correcta y accesible)
        ...
        if (file_exists($ruta_foto) && !empty($ruta_foto)) {
            $contenido_pdf .= "0 -40 Td\n<</Type /XObject /Subtype /Image /Width 150 /Height 150 /BitsPerComponent 8 /Filter /DCTDecode /Length " . filesize($ruta_foto) . ">>\nstream\n";
