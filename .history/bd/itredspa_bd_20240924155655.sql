...
CREATE TABLE E_Empresa (
    ...
    telefono_empresa VARCHAR(20) NOT NULL, -- Teléfono de la empresa
    email_empresa VARCHAR(100) NOT NULL, -- Email de la empresa
    fecha_creacion DATE NOT NULL, -- fecha de creacion de la empresa
    dias_validez INT,
