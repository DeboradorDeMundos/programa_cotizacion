...
CREATE TABLE C_Cotizaciones (
    ...
    id_detalle INT -- ID del detalle (clave foránea)
    ...
    FOREIGN KEY (id_detalle) REFERENCES E_C_Detalle_Cotizacion(id_detalle) ON DELETE SET NULL -- Clave foránea hacia Cuenta_Bancaria
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
DROP TABLE IF EXISTS C_Descripciones;
...
CREATE TABLE C_Descripciones (
    ...
    descripcion text , -- Descripción detallada del ítem o servicio
    cantidad int NOT NULL, -- cantidad de item o servicio
    ...
    FOREIGN KEY (id_titulo) REFERENCES C_Titulos(id_titulo) ON DELETE CASCADE -- Clave foránea hacia Titulos
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
...
DROP TABLE IF EXISTS C_Detalle_Cotizacion;
...
CREATE TABLE C_Detalle_Cotizacion (
    ...
    sub_total INT(10), -- Sub Total de la cotización
    ...
    FOREIGN KEY (id_cotizacion) REFERENCES C_Cotizaciones(id_cotizacion) ON DELETE CASCADE, -- Clave foránea hacia Cotizaciones
    FOREIGN KEY (id_descripcion) REFERENCES C_Descripciones(id_descripcion) ON DELETE CASCADE -- Clave foránea hacia Descripciones
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish_ci;
