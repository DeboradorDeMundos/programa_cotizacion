...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="php/programa_cotizacion/ver_listado/ver_listado.php">Ver listado Cotización</a></li><!-- Enlace para ver el listado de cotizaciones -->
        </ul>
    </nav>
</body>
</html>
